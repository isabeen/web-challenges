...
window.addEventListener("scroll", function calculateScrollPercentage() {
  let scrollHeight = progressBar - this.window.innerHeight;
  let windowPosition = window.scrollY;
  let scrollPercentage = (windowPosition / scrollHeight) * 100;
});
